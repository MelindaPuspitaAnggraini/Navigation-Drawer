...
// === Warna Utama (Primary) ===
val Primary = Color(0xFF1565C0)          // Biru utama
val PrimaryDark = Color(0xFF0D47A1)      // Biru gelap
val PrimaryLight = Color(0xFF42A5F5)     // Biru terang
...
// === Warna Top App Bar ===
val TopBarBackground = Color(0xFF1565C0) // Sama dengan Primary
val TopBarContent = Color(0xFFFFFFFF)    // Putih

// === Warna Drawer ===
val DrawerHeaderBackground = Color(0xFF0D47A1)    // Biru gelap
val DrawerHeaderText = Color(0xFFFFFFFF)           // Putih
val DrawerItemSelected = Color(0xFFE3F2FD)         // Biru sangat terang
val DrawerItemSelectedText = Color(0xFF1565C0)     // Biru utama
...
// === Warna Icon ===
val IconActive = Color(0xFF1565C0)       // Biru (aktif)
